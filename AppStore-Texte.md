# App-Store-Texte für RezeptWerk
...
Apple indexiert die Wörter im Namen fürs Suchen – darum lohnt ein Zusatz:

```
RezeptWerk: Grill & Wurst
```
*(25 Zeichen)*

Alternativen:
- `RezeptWerk` *(schlicht, 10 Zeichen)*
- `RezeptWerk – Wursten & BBQ` *(26 Zeichen)*

---

## 2. Untertitel (max. 30 Zeichen)

```
Grillen · Wursten · Räuchern
```
*(28 Zeichen)*

---

## 3. Keywords (max. 100 Zeichen, mit Komma getrennt, keine Leerzeichen)

Wörter aus Name & Untertitel NICHT wiederholen (sind schon indexiert):

```
wurst,smoker,bbq,pökeln,rezeptbuch,kochbuch,brühwurst,rohwurst,dutchoven,schinken,marinade,smoken
```
*(97 Zeichen)*
...
• Nitritpökelsalz (NPS) pro kg, Gewürzmengen, Kutterhilfsmittel
• Darm & Kaliber, Schüttung/Eiswasser
...
✅ FAIR & EHRLICH
Einmal kaufen, für immer nutzen. Kein Abo, keine versteckten Kosten.
...
```
Version 1.5 bringt Werkzeuge für Grill und Wurstküche:

🌡 KERNTEMPERATUR-SPICKZETTEL
Gar-Temperaturen für Rind, Schwein, Geflügel, Lamm & Wild, Fisch sowie Wurst & Räuchern – offline in der App, mit Suche.

⚖️ WURST-RECHNER
Fleisch-Mix aus mehreren Sorten eingeben (mit Prozent-Anteilen), Zutaten je kg pflegen – alle Mengen rechnen sich sofort hoch. Mit Vorlagen für Brühwurst, Rohwurst und Rohschinken. Das Ergebnis lässt sich als fertiges Rezept speichern – inklusive Fachdaten.

📓 KOCH-NOTIZEN
Halte nach dem Kochen fest, wie es gelaufen ist („nächstes Mal weniger Salz“) – direkt auf der Abschlussseite des Kochmodus oder im Rezept. Mit Datum, im Backup enthalten.

📱 HOMESCREEN-WIDGET
„Heute auf dem Wochenplan“ zeigt deine geplanten Mahlzeiten direkt auf dem Startbildschirm.

Guten Appetit – und gut Wurst!
```
*(ca. 830 Zeichen — Limit 4000)*

> Falls Version 1.4 nie separat im App Store erschienen ist, diesen Satz
> zusätzlich aufnehmen: „NEU AUSSERDEM: Wichtige Hinweise (z. B. vor
> Updates) erscheinen jetzt direkt in der App.“

### Für Version 1.0 (historisch)

```
Willkommen bei RezeptWerk! Die erste Version ist da – mit allem fürs Kochen, Grillen, Wursten und Räuchern: Rezeptverwaltung, Import per Foto/PDF/Web, Kochmodus, iCloud-Sync, Backup und PDF-Export. Viel Freude!
```

---

## 7. Kategorie & Einstufung (in App Store Connect)

- **Primäre Kategorie:** Essen & Trinken (Food & Drink)
- **Sekundäre Kategorie:** Lifestyle (optional)
- **Alter:** 4+ (keine bedenklichen Inhalte)
- **Preis:** Stufe für 0,99 € (Apple zieht 15 % ab → dir bleiben ca. 0,84 €)

---

## 8. Pflicht-Angaben, die du noch brauchst

- **Datenschutzrichtlinie (URL):** Pflicht, auch bei lokalen Apps. Da
  RezeptWerk keine Daten sammelt, genügt eine kurze Seite mit dem Satz:
  „RezeptWerk speichert alle Daten ausschließlich lokal auf dem Gerät bzw.
  in der privaten iCloud des Nutzers. Es werden keine Daten erhoben,
  übertragen oder an Dritte weitergegeben." (z. B. kostenlos über GitHub
